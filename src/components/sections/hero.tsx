      ...
      <div className="container-custom">
        <div className={`grid grid-cols-1 lg:grid-cols-2 gap-12 items-center transition-opacity duration-500 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
          ...
          <div className="relative rounded-2xl overflow-hidden shadow-2xl bg-white/5 backdrop-blur-sm">
            <iframe className="w-full aspect-video rounded-2xl" src="https://www.youtube.com/embed/sJGVcb5fn2c?autoplay=1&mute=1&loop=1&controls=0&playlist=sJGVcb5fn2c" title="SkillSeeker Demonstration" frameBorder="0" allow="autoplay; encrypted-media; picture-in-picture" allowFullScreen loading="lazy" />
